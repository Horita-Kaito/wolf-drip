      ...
      <div className="max-w-6xl mx-auto">
        ...
        <form ref={formRef} className="max-w-2xl mx-auto space-y-8">
          <div className="form-field grid md:grid-cols-2 gap-6">
            <div>
              <label className="block text-xs tracking-[0.2em] uppercase text-[var(--color-clay)] mb-3 font-[family-name:var(--font-body)]">
                Name
              </label>
              <input
                type="text"
                placeholder="お名前"
                className="w-full bg-transparent border-b border-[var(--color-border)] focus:border-[var(--color-clay)] pb-3 text-[var(--color-fg)] placeholder:text-[var(--color-placeholder)] outline-none transition-colors duration-300 font-[family-name:var(--font-body-ja)]"
              />
            </div>
            <div>
              <label className="block text-xs tracking-[0.2em] uppercase text-[var(--color-clay)] mb-3 font-[family-name:var(--font-body)]">
          ...
          <div className="form-field">
            ...
            <textarea
              rows={5}
              placeholder="メッセージ"
              className="w-full bg-transparent border-b border-[var(--color-border)] focus:border-[var(--color-clay)] pb-3 text-[var(--color-fg)] placeholder:text-[var(--color-placeholder)] outline-none transition-colors duration-300 resize-none font-[family-name:var(--font-body-ja)]"
            />
          </div>
